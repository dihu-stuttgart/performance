...
def run(xi1,ode,msolver,mprecond):   
  ...
  command = "$OPENCMISS_REL_DIR/cuboid $OPENCMISS_SCE_FILE $OPENCMISS_INPUT_DIR xi1={} ODESolverId={} MonodomainSolverId={} MonodomainPreconditionerId={} StimPeriod=1 SplittingType=1"\
