...
def number_of_processes(p,x,y,z,ax,ay,az,debug=False):
  """
  determine the number of processes that will be used for a domain decomposition parameterized by (x,y,z,ax,ay,az)
  """
  ...
  return (nSubdomains, (nAtomsPerSubdomainX*NumberOfElementsInAtomX, nAtomsPerSubdomainY*NumberOfElementsInAtomY, nAtomsPerSubdomainZ*NumberOfElementsInAtomZ))
