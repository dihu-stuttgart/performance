...
def extract_data(data):
  ...
  for dataset in data:
    ...
    # define sorting key
    key = "{:04d}_{}".format(new_data[8],new_data[109])
...
print ""
print "------------- duration -------------------------------------------"
print "{:20}, {:6}, {:6}, {:6}, {:10}, {:10}, {:10}, {:13}, {:10}, {:10}, {:10}".\
format("key", "nproc", "#M", "#FE", "total", "total: 0D", "1D", "3D", "solve: 0D", "1D", "3D")
for key in datasets:
  
  print "{:20}, {:6}, {:6d}, {:6d}, {:10}, {:10}, {:10}, {:13}, {:10}, {:10}, {:10}".\
...
if paper_no_legend:
  ...
  plt.figure("improved (12)", figsize=(14,8))
