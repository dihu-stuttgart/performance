...
# ------------- numerics -------------------
TimeStop = 1.99                  # total simulated time
ODETimeStep = 0.05            # timestep size for 0D problem
PDETimeStep = 0.05    ! 0.005 # timestep size for 1D problem
...
StimValue = 2000.0             # current value with which fibres are stimulated
