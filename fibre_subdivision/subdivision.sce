# Scenario name: fibre subdivision test, case with subdivision
# Date: 18.6.17
# Author: Benjamin Maier
# dihu-stuttgart/iron version: e8356399df9a4f10e275ebe249ddaa25048a1a2b (branch subdivide_fibres)
# dihu-stuttgart/iron-examples version: 5f333fd2082d00b1e679cb94ced425fb5b1be690 (branch subdivide_fibres)
#
# Designated number of Processors: 8
...
NumberGlobalXElements = 8      # number of finite elasticty elements in x-direction, alias x
NumberGlobalYElements = 8       # number of finite elasticty elements in y-direction, alias y
NumberGlobalZElements = 8       # number of finite elasticty elements in z-direction, alias z
