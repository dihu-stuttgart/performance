...
def extract_data(data):
  ...
  for dataset in data:
    ...
    # define sorting key
    key = "{:04d}|{:01d}".format(new_data[7], new_data[102])
...
labels = {
  ...
  17: "ODE solver",
  "parabolic1|1": "Parabolic solver (LU)",
  "parabolic2|1": "Parabolic solver (GMRES)",
  "parabolic3|1": "Parabolic solver (CG, no precond.)",
