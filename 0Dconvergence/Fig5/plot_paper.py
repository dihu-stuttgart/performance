...
plt.plot(abs((data_euler[:,1]+69.9623461445)/69.9623461445), data_euler[:,61]/0.002, 'bo-', label=r"Euler, $V_\mathrm{m}$")
plt.plot(abs((dat_heun[:-1,1]+69.9623461445)/69.9623461445), dat_heun[:-1,61]/0.002, 'go-', label=r"Heun, $V_\mathrm{m}$")
