...
data_euler = np.genfromtxt("Euler.txt")
dat_heun = np.genfromtxt("Heun.txt")
...
plt.plot(data_euler[:,0], abs((data_euler[:,1]+78.9451121580)/78.9451121580), 'b-', label=r"Euler, $V_\mathrm{m}$")
plt.plot(data_euler[:,0], abs((data_euler[:,59]+1189.84540438)/1189.84540438), 'b--', label=r"Euler, $I_\mathrm{ion}$")
plt.plot(dat_heun[:-1,0], abs((dat_heun[:-1,1]+78.9451121580)/78.9451121580), 'g-', label=r"Heun, $V_\mathrm{m}$")
plt.plot(dat_heun[:-1,0], abs((dat_heun[:-1,59]+1189.84540438)/1189.84540438), 'g--', label=r"Heun, $I_\mathrm{ion}$")
