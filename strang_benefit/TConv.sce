# Scenario name: improvements for paper, to compute the convergence rate
# Date: 29.9.17
# Author: Benjamin Maier, Nehzat Emamy
# dihu-stuttgart/iron version: 78e306d3a667554bcc53fec4dad12ade74d97337  (branch WORKING_STRANG_DEBUG)
# dihu-stuttgart/iron-examples version: fb961377afaf11bca1157c5ea1aff747a5164ad3  (branch WORKING_STRANG_DEBUG)
#
# Designated number of Processors: 4
...
# ------------- debugging --------------------
OutputTimeStepStride = 200       # write output *.exnode files every nth timestep
...
# ------------- numerics -------------------
# time steps
TimeStop = 5.0                 # total simulated time, note that the real simulated time is always a multiple of StimPeriod
...
OdeNSteps = 2                   # number of timesteps for ODESolver (overrides ODETimeStep if != -1)

# splitting
UseStrangSplitting = T               # 0 = Godunov splitting, 1 = Strang splitting (note: for 2nd order you should also set ODESolverId to 5)

# solvers
ODESolverId = 5                 # 0D problem, ODE solver type: 1=explicit Euler, 5=Heun
...
StimPeriod = 2.5            # the duration between subsequent stimulation spikes, former PERIODD
...
# CellMLModelFilename
# ModelType = 0 (MultiPhysStrain): {InputDirectory}/new_slow_TK_2014_12_08.xml
