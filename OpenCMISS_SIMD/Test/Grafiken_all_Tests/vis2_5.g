...
plot 'Data/V-4_V1.dat2'  u 3:($19/1000) smooth unique w lines linecolor 0 lw 1.5 lt 1 t "Memory (19)",\
     'Data/OCV_V1.dat2'  u 3:($23/1000) smooth unique w lines linecolor 0 lw 2.0 lt 0 t "Used (23), OpenCMISS",\
     'Data/V-1_V1.dat2'  u 3:($23/1000) smooth unique w lines linecolor 2 lw 2.0 lt 0 t "{/Symbol a}-Version",\
     'Data/V-4_V1.dat2'  u 3:($23/1000) smooth unique w lines linecolor 4 lw 2.0 lt 0 t "{/Symbol b}-Version",\
