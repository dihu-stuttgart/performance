...
#include "RHS_routine.h"
   ...
   int forwardEulerForAVX(double timeSpan, int Ksteps,
                      ...
                      double* gamma_OutFromRhs, double* StimValue_INtoRHS,  double* L_hs_INtoRHS, int NumberOfCells, clock_t * handle_array, double * portions_array, int* usedRamSize_ptr){
   double dt_0D;
   int k;
   int cell;
   ...
   for(k=1; k<=Ksteps; k++){
      RHS_routineForAVX(state0, state1, state2, state3, state4, state5, state6, state7, state8, state9, state10,state11,state12,state13,state14,state15,state16,state17,state18,state19,
                        ...
                        gamma_OutFromRhs,StimValue_INtoRHS,L_hs_INtoRHS, handle_array, portions_array,usedRamSize_ptr);
...
int improvedEulerForAVX(double timeSpan, int Ksteps,
  ...
  /* double stateCopy_0[NumberOfCells],  stateCopy_1[NumberOfCells],  stateCopy_2[NumberOfCells],  stateCopy_3[NumberOfCells],  stateCopy_4[NumberOfCells],  stateCopy_5[NumberOfCells],  stateCopy_6[NumberOfCells],  stateCopy_7[NumberOfCells],  stateCopy_8[NumberOfCells],  stateCopy_9[NumberOfCells],
   ...
   double *stateCopy_0,  *stateCopy_1,  *stateCopy_2,  *stateCopy_3,  *stateCopy_4,  *stateCopy_5,  *stateCopy_6,  *stateCopy_7,  *stateCopy_8,  *stateCopy_9,
          *stateCopy_10, *stateCopy_11, *stateCopy_12, *stateCopy_13, *stateCopy_14, *stateCopy_15, *stateCopy_16, *stateCopy_17, *stateCopy_18, *stateCopy_19,
          *stateCopy_20, *stateCopy_21, *stateCopy_22, *stateCopy_23, *stateCopy_24, *stateCopy_25, *stateCopy_26, *stateCopy_27, *stateCopy_28, *stateCopy_29,
          *stateCopy_30, *stateCopy_31, *stateCopy_32, *stateCopy_33, *stateCopy_34, *stateCopy_35, *stateCopy_36, *stateCopy_37, *stateCopy_38, *stateCopy_39,
          *stateCopy_40, *stateCopy_41, *stateCopy_42, *stateCopy_43, *stateCopy_44, *stateCopy_45, *stateCopy_46, *stateCopy_47, *stateCopy_48, *stateCopy_49,
          *stateCopy_50, *stateCopy_51, *stateCopy_52, *stateCopy_53, *stateCopy_54, *stateCopy_55, *stateCopy_56,
          *rate2_0,  *rate2_1,  *rate2_2,  *rate2_3,  *rate2_4,  *rate2_5,  *rate2_6,  *rate2_7,  *rate2_8,  *rate2_9,
          *rate2_10, *rate2_11, *rate2_12, *rate2_13, *rate2_14, *rate2_15, *rate2_16, *rate2_17, *rate2_18, *rate2_19,
          *rate2_20, *rate2_21, *rate2_22, *rate2_23, *rate2_24, *rate2_25, *rate2_26, *rate2_27, *rate2_28, *rate2_29,
          *rate2_30, *rate2_31, *rate2_32, *rate2_33, *rate2_34, *rate2_35, *rate2_36, *rate2_37, *rate2_38, *rate2_39,
          *rate2_40, *rate2_41, *rate2_42, *rate2_43, *rate2_44, *rate2_45, *rate2_46, *rate2_47, *rate2_48, *rate2_49,
          *rate2_50, *rate2_51, *rate2_52, *rate2_53, *rate2_54, *rate2_55, *rate2_56;
      
   handle_array[0] = clock(); // time for malloc
   
   stateCopy_0 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_1 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_2 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_3 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_4 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_5 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_6 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_7 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_8 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_9 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_10 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_11 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_12 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_13 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_14 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_15 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_16 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_17 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_18 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_19 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_20 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_21 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_22 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_23 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_24 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_25 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_26 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_27 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_28 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_29 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_30 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_31 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_32 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_33 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_34 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_35 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_36 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_37 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_38 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_39 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_40 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_41 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_42 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_43 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_44 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_45 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_46 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_47 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_48 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_49 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_50 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_51 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_52 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_53 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_54 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_55 = malloc(sizeof(double)*NumberOfCells);
   stateCopy_56 = malloc(sizeof(double)*NumberOfCells);
   rate2_0 = malloc(sizeof(double)*NumberOfCells);
   rate2_1 = malloc(sizeof(double)*NumberOfCells);
   rate2_2 = malloc(sizeof(double)*NumberOfCells);
   rate2_3 = malloc(sizeof(double)*NumberOfCells);
   rate2_4 = malloc(sizeof(double)*NumberOfCells);
   rate2_5 = malloc(sizeof(double)*NumberOfCells);
   rate2_6 = malloc(sizeof(double)*NumberOfCells);
   rate2_7 = malloc(sizeof(double)*NumberOfCells);
   rate2_8 = malloc(sizeof(double)*NumberOfCells);
   rate2_9 = malloc(sizeof(double)*NumberOfCells);
   rate2_10 = malloc(sizeof(double)*NumberOfCells);
   rate2_11 = malloc(sizeof(double)*NumberOfCells);
   rate2_12 = malloc(sizeof(double)*NumberOfCells);
   rate2_13 = malloc(sizeof(double)*NumberOfCells);
   rate2_14 = malloc(sizeof(double)*NumberOfCells);
   rate2_15 = malloc(sizeof(double)*NumberOfCells);
   rate2_16 = malloc(sizeof(double)*NumberOfCells);
   rate2_17 = malloc(sizeof(double)*NumberOfCells);
   rate2_18 = malloc(sizeof(double)*NumberOfCells);
   rate2_19 = malloc(sizeof(double)*NumberOfCells);
   rate2_20 = malloc(sizeof(double)*NumberOfCells);
   rate2_21 = malloc(sizeof(double)*NumberOfCells);
   rate2_22 = malloc(sizeof(double)*NumberOfCells);
   rate2_23 = malloc(sizeof(double)*NumberOfCells);
   rate2_24 = malloc(sizeof(double)*NumberOfCells);
   rate2_25 = malloc(sizeof(double)*NumberOfCells);
   rate2_26 = malloc(sizeof(double)*NumberOfCells);
   rate2_27 = malloc(sizeof(double)*NumberOfCells);
   rate2_28 = malloc(sizeof(double)*NumberOfCells);
   rate2_29 = malloc(sizeof(double)*NumberOfCells);
   rate2_30 = malloc(sizeof(double)*NumberOfCells);
   rate2_31 = malloc(sizeof(double)*NumberOfCells);
   rate2_32 = malloc(sizeof(double)*NumberOfCells);
   rate2_33 = malloc(sizeof(double)*NumberOfCells);
   rate2_34 = malloc(sizeof(double)*NumberOfCells);
   rate2_35 = malloc(sizeof(double)*NumberOfCells);
   rate2_36 = malloc(sizeof(double)*NumberOfCells);
   rate2_37 = malloc(sizeof(double)*NumberOfCells);
   rate2_38 = malloc(sizeof(double)*NumberOfCells);
   rate2_39 = malloc(sizeof(double)*NumberOfCells);
   rate2_40 = malloc(sizeof(double)*NumberOfCells);
   rate2_41 = malloc(sizeof(double)*NumberOfCells);
   rate2_42 = malloc(sizeof(double)*NumberOfCells);
   rate2_43 = malloc(sizeof(double)*NumberOfCells);
   rate2_44 = malloc(sizeof(double)*NumberOfCells);
   rate2_45 = malloc(sizeof(double)*NumberOfCells);
   rate2_46 = malloc(sizeof(double)*NumberOfCells);
   rate2_47 = malloc(sizeof(double)*NumberOfCells);
   rate2_48 = malloc(sizeof(double)*NumberOfCells);
   rate2_49 = malloc(sizeof(double)*NumberOfCells);
   rate2_50 = malloc(sizeof(double)*NumberOfCells);
   rate2_51 = malloc(sizeof(double)*NumberOfCells);
   rate2_52 = malloc(sizeof(double)*NumberOfCells);
   rate2_53 = malloc(sizeof(double)*NumberOfCells);
   rate2_54 = malloc(sizeof(double)*NumberOfCells);
   rate2_55 = malloc(sizeof(double)*NumberOfCells);
   rate2_56 = malloc(sizeof(double)*NumberOfCells);
   ...
   if(actualUsedRAM > *usedRamSize_ptr){*usedRamSize_ptr=actualUsedRAM;}
   
   handle_array[7] = clock(); // time for getting memory consumption
   portions_array[7] += ((double) (handle_array[7]-handle_array[1])) / CLOCKS_PER_SEC;
...
#pragma GCC ivdep     // needed, otherwise not vectorized
      for(cell=1; cell<=NumberOfCells; cell++){ /* step forward to compute new state*/
         state0[cell] = stateCopy_0[cell] + dt_0D * (rate0[cell] + rate2_0[cell])*0.5;
         state1[cell] = stateCopy_1[cell] + dt_0D * (rate1[cell] + rate2_1[cell])*0.5;
         state2[cell] = stateCopy_2[cell] + dt_0D * (rate2[cell] + rate2_2[cell])*0.5;
         state3[cell] = stateCopy_3[cell] + dt_0D * (rate3[cell] + rate2_3[cell])*0.5;
         state4[cell] = stateCopy_4[cell] + dt_0D * (rate4[cell] + rate2_4[cell])*0.5;
         state5[cell] = stateCopy_5[cell] + dt_0D * (rate5[cell] + rate2_5[cell])*0.5;
         state6[cell] = stateCopy_6[cell] + dt_0D * (rate6[cell] + rate2_6[cell])*0.5;
         state7[cell] = stateCopy_7[cell] + dt_0D * (rate7[cell] + rate2_7[cell])*0.5;
         state8[cell] = stateCopy_8[cell] + dt_0D * (rate8[cell] + rate2_8[cell])*0.5;
         state9[cell] = stateCopy_9[cell] + dt_0D * (rate9[cell] + rate2_9[cell])*0.5;
         state10[cell] = stateCopy_10[cell] + dt_0D * (rate10[cell] + rate2_10[cell])*0.5;
         state11[cell] = stateCopy_11[cell] + dt_0D * (rate11[cell] + rate2_11[cell])*0.5;
         state12[cell] = stateCopy_12[cell] + dt_0D * (rate12[cell] + rate2_12[cell])*0.5;
         state13[cell] = stateCopy_13[cell] + dt_0D * (rate13[cell] + rate2_13[cell])*0.5;
         state14[cell] = stateCopy_14[cell] + dt_0D * (rate14[cell] + rate2_14[cell])*0.5;
         state15[cell] = stateCopy_15[cell] + dt_0D * (rate15[cell] + rate2_15[cell])*0.5;
         state16[cell] = stateCopy_16[cell] + dt_0D * (rate16[cell] + rate2_16[cell])*0.5;
         state17[cell] = stateCopy_17[cell] + dt_0D * (rate17[cell] + rate2_17[cell])*0.5;
         state18[cell] = stateCopy_18[cell] + dt_0D * (rate18[cell] + rate2_18[cell])*0.5;
         state19[cell] = stateCopy_19[cell] + dt_0D * (rate19[cell] + rate2_19[cell])*0.5;
         state20[cell] = stateCopy_20[cell] + dt_0D * (rate20[cell] + rate2_20[cell])*0.5;
         state21[cell] = stateCopy_21[cell] + dt_0D * (rate21[cell] + rate2_21[cell])*0.5;
         state22[cell] = stateCopy_22[cell] + dt_0D * (rate22[cell] + rate2_22[cell])*0.5;
         state23[cell] = stateCopy_23[cell] + dt_0D * (rate23[cell] + rate2_23[cell])*0.5;
         state24[cell] = stateCopy_24[cell] + dt_0D * (rate24[cell] + rate2_24[cell])*0.5;
         state25[cell] = stateCopy_25[cell] + dt_0D * (rate25[cell] + rate2_25[cell])*0.5;
         state26[cell] = stateCopy_26[cell] + dt_0D * (rate26[cell] + rate2_26[cell])*0.5;
         state27[cell] = stateCopy_27[cell] + dt_0D * (rate27[cell] + rate2_27[cell])*0.5;
         state28[cell] = 0.0; //not necessary
         state29[cell] = stateCopy_29[cell] + dt_0D * (rate29[cell] + rate2_29[cell])*0.5;
         state30[cell] = stateCopy_30[cell] + dt_0D * (rate30[cell] + rate2_30[cell])*0.5;
         state31[cell] = stateCopy_31[cell] + dt_0D * (rate31[cell] + rate2_31[cell])*0.5;
         state32[cell] = stateCopy_32[cell] + dt_0D * (rate32[cell] + rate2_32[cell])*0.5;
         state33[cell] = stateCopy_33[cell] + dt_0D * (rate33[cell] + rate2_33[cell])*0.5;
         state34[cell] = stateCopy_34[cell] + dt_0D * (rate34[cell] + rate2_34[cell])*0.5;
         state35[cell] = stateCopy_35[cell] + dt_0D * (rate35[cell] + rate2_35[cell])*0.5;
         state36[cell] = stateCopy_36[cell] + dt_0D * (rate36[cell] + rate2_36[cell])*0.5;
         state37[cell] = stateCopy_37[cell] + dt_0D * (rate37[cell] + rate2_37[cell])*0.5;
         state38[cell] = stateCopy_38[cell] + dt_0D * (rate38[cell] + rate2_38[cell])*0.5;
         state39[cell] = stateCopy_39[cell] + dt_0D * (rate39[cell] + rate2_39[cell])*0.5;
         state40[cell] = stateCopy_40[cell] + dt_0D * (rate40[cell] + rate2_40[cell])*0.5;
         state41[cell] = stateCopy_41[cell] + dt_0D * (rate41[cell] + rate2_41[cell])*0.5;
         state42[cell] = stateCopy_42[cell] + dt_0D * (rate42[cell] + rate2_42[cell])*0.5;
         state43[cell] = stateCopy_43[cell] + dt_0D * (rate43[cell] + rate2_43[cell])*0.5;
         state44[cell] = stateCopy_44[cell] + dt_0D * (rate44[cell] + rate2_44[cell])*0.5;
         state45[cell] = stateCopy_45[cell] + dt_0D * (rate45[cell] + rate2_45[cell])*0.5;
         state46[cell] = stateCopy_46[cell] + dt_0D * (rate46[cell] + rate2_46[cell])*0.5;
         state47[cell] = stateCopy_47[cell] + dt_0D * (rate47[cell] + rate2_47[cell])*0.5;
         state48[cell] = stateCopy_48[cell] + dt_0D * (rate48[cell] + rate2_48[cell])*0.5;
         state49[cell] = stateCopy_49[cell] + dt_0D * (rate49[cell] + rate2_49[cell])*0.5;
         state50[cell] = stateCopy_50[cell] + dt_0D * (rate50[cell] + rate2_50[cell])*0.5;
         state51[cell] = stateCopy_51[cell] + dt_0D * (rate51[cell] + rate2_51[cell])*0.5;
         state52[cell] = stateCopy_52[cell] + dt_0D * (rate52[cell] + rate2_52[cell])*0.5;
         state53[cell] = stateCopy_53[cell] + dt_0D * (rate53[cell] + rate2_53[cell])*0.5;
         state54[cell] = stateCopy_54[cell] + dt_0D * (rate54[cell] + rate2_54[cell])*0.5;
         state55[cell] = stateCopy_55[cell] + dt_0D * (rate55[cell] + rate2_55[cell])*0.5;
         state56[cell] = stateCopy_56[cell] + dt_0D * (rate56[cell] + rate2_56[cell])*0.5;
      } 
      handle_array[2]=clock();
      // time to actualize states (plus COPY if T==1):  (Is part of [0].)
      portions_array[2] += ((double) (handle_array[2]-handle_array[1])) / CLOCKS_PER_SEC;
   ...
   portions_array[0] += ((double) (handle_array[1]-handle_array[0])) / CLOCKS_PER_SEC;
   // time to compute L_hs after numerical integration:
   portions_array[1] += ((double) (handle_array[2]-handle_array[7])) / CLOCKS_PER_SEC;
  return 0;
 }
