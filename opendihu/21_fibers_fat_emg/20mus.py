...
# however, values from paper fail with multidomain for mu >= 6, then stimulus gets reflected at the ends of the muscle, therefore fiber radius is set to <= 55
...
output_timestep_surface = 1e3       # [ms] timestep for output surface EMG, 0.5
...
fiber_distribution_file = "MU_fibre_distribution_13x13_20mus.txt"
...
fast_monodomain_solver_optimizations = True # enable the optimizations in the fast monodomain solver
