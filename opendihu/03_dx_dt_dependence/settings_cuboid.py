# Cuboid
#
# arguments: <n_processes_per_fiber> <n_fibers> <n_nodes_per_fiber_per_cm> <dt_1D> <scenario_name>
...
firing_times_file = "MU_firing_times.txt"
...
dt_0D = min(2e-4,dt_1D)
dt_splitting = min(dt_1D,dt_0D)
