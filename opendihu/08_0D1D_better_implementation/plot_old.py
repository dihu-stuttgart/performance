...
input_filename_no_rr = "log_no_rr.csv"
input_filename_nofast_1D = "weak_scaling_paper.csv"
input_filename_fast_1D = "log_10.csv"
...
df = load_df(input_filename_nofast_1D)
...
print_table(df_weak_scaling, "", "weak_scaling2", columns_to_plot, mylabels, None, [(0.7,0.76,0.7), (0.1,0.1,0.6), 'r', 'y', (0.6,0.6,1.0)])
...
df_fast = load_df(input_filename_fast_1D)
...
print(df_fast.groupby(['nRanks']).mean()['nIterations_activationSolver'])

print_table(df_fast, "Weak scaling on Hazel Hen", columns_to_plot, mylabels)
