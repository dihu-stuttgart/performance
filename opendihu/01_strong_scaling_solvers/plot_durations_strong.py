...
print(df_all["implicitSolver_solverType"])
...
print("cg: {}".format(len(df_cg.index)))
print("cg_boomerang: {}".format(len(df_cg_boomeramg.index)))
print("gamg: {}".format(len(df_gamg.index)))
