...
print("contained solvers: ")
print(df_all.implicitSolver_solverType.unique())
...
for solver in ["lu", "cg", "gmres", "gamg"]:
  ...
  #for elem in [200,500,1480,5000]:
    #print(df_solver.info())
    #print(df_solver)
    
    df_plot=df_solver[df_solver['~nDofs']== dofs]
    ...
    legend_list.append(solver+"-"+str(dofs))
