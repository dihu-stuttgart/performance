...
print("means: ")
print(means["durationWriteOutputExfile"])
print(means["durationWriteOutputMegamol"])
print(means["durationWriteOutputParaview"])
print(means["totalUsertime"])
...
print_table(df_gmres, "GMRES", columns_to_plot, mylabels)
