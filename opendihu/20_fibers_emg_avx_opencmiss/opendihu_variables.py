...
# timing parameters
# -----------------
end_time = 2.0                     # [ms] end time of the simulation
...
dt_1D = 5e-4                        # [ms] timestep width of diffusion (4e-3)
dt_splitting = 5e-4                 # [ms] overall timestep width of strang splitting (4e-3)
...
output_timestep_fibers = 1e-1       # [ms] timestep for fiber output, 0.5
...
approximate_exponential_function = True
...
firing_times_file       = input_directory+"/MU_firing_times_immediately.txt"
