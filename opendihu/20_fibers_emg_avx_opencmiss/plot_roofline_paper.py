...
ax.text(1e-3, 10, "L1: 3679 GB/s", ha="left", color=mem_color, rotation=65)
ax.text(5e-3, 10, "L2: 2442 GB/s", ha="left", color=mem_color, rotation=65)
ax.text(5e-2, 10, "L3: 36.1 GB/s", ha="left", color=mem_color, rotation=65)
ax.text(4e-1, 10, "DRAM: 94 GB/s", ha="left", color=mem_color, rotation=65)
