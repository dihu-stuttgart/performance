...
ordered_values = ['n', 'total', '0D', '1D', "bidomain", 'stiffness', 'initCell', 'initBC', 'read', 'write', 'compMap', 'map', "mem"]
...
print_table(df_cray, "Cray compiler (without rank reordering)", columns_to_plot)
