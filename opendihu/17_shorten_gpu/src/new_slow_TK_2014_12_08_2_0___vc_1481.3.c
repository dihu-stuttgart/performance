...
// This function was created by opendihu at 2021/1/19 16:28:38.
// It is designed for 1481 instances of the CellML problem.
...
void computeCellMLRightHandSide(void *context, double t, double *states, double *rates, double *algebraics, double *parameters)
{
  ...
  {
    std::cout << "Fatal error in compiled library of source file \"src/new_slow_TK_2014_12_08_2_0___vc_1481.3.c\", size of SIMD register in compiled code (" << Vc::double_v::Size << ") does not match opendihu code (4)." << std::endl;
  ...
  const int nInstances = 1481;
  const int nStates = 57;
  const int nAlgebraics = 71;
  const int nParametersPerInstance = 71;
  const int nVcVectors = 371;  // ceil(1481 instances / VcSize 4)
  Vc::double_v statesVc[nStates*nVcVectors];  // 57 states * 371 vectors
  Vc::double_v ratesVc[nStates*nVcVectors];   // 57 rates  * 371 vectors
  Vc::double_v algebraicsVc[nAlgebraics*nVcVectors];  // 71 algebraics  * 371 vectors
  Vc::double_v parametersVc[nParametersPerInstance*nVcVectors];  // 71 parameters  * 371 vectors
  ...
  {
    ratesVc[10759+i] = (((( ( CONSTANTS[105]*(statesVc[6678+i]+statesVc[7049+i]+statesVc[7420+i]+statesVc[7791+i]+statesVc[8162+i]))*((statesVc[11130+i] - statesVc[10759+i])/CONSTANTS[108]) -  CONSTANTS[61]*((statesVc[10759+i]/(statesVc[10759+i]+CONSTANTS[62]))/CONSTANTS[108]))+ CONSTANTS[63]*((statesVc[11130+i] - statesVc[10759+i])/CONSTANTS[108]))+ - CONSTANTS[64]*((statesVc[10759+i] - statesVc[11501+i])/CONSTANTS[108]))+- ( ( CONSTANTS[72]*statesVc[10759+i])*((CONSTANTS[74]+- statesVc[12614+i])+- statesVc[13356+i])+ - CONSTANTS[73]*statesVc[12614+i]))+- ( ( CONSTANTS[80]*statesVc[10759+i])*statesVc[16324+i]+ - CONSTANTS[81]*statesVc[14840+i]);
    ratesVc[11130+i] = ((( - ( CONSTANTS[105]*(statesVc[6678+i]+statesVc[7049+i]+statesVc[7420+i]+statesVc[7791+i]+statesVc[8162+i]))*((statesVc[11130+i] - statesVc[10759+i])/CONSTANTS[110])+ CONSTANTS[61]*((statesVc[10759+i]/(statesVc[10759+i]+CONSTANTS[62]))/CONSTANTS[110]))+ - CONSTANTS[63]*((statesVc[11130+i] - statesVc[10759+i])/CONSTANTS[110]))+ - CONSTANTS[65]*((statesVc[11130+i] - statesVc[11872+i])/CONSTANTS[110]))+- ( ( CONSTANTS[77]*statesVc[11130+i])*(CONSTANTS[79] - statesVc[14098+i])+ - CONSTANTS[78]*statesVc[14098+i]);
    ratesVc[11872+i] = ((( CONSTANTS[61]*((statesVc[11501+i]/(statesVc[11501+i]+CONSTANTS[62]))/CONSTANTS[111])+ - CONSTANTS[63]*((statesVc[11872+i]+- statesVc[11501+i])/CONSTANTS[111]))+ CONSTANTS[65]*((statesVc[11130+i]+- statesVc[11872+i])/CONSTANTS[111]))+- ( ( CONSTANTS[77]*statesVc[11872+i])*(CONSTANTS[79]+- statesVc[14469+i])+ - CONSTANTS[78]*statesVc[14469+i])) -  (1000.00/1.00000)*( CONSTANTS[97]*( statesVc[20405+i]*(0.00100000/1.00000)*statesVc[11872+i] - CONSTANTS[99])*(Vc::iif( statesVc[20405+i]*(0.00100000/1.00000)*statesVc[11872+i] - CONSTANTS[99]>0.00000 , Vc::double_v(Vc::One), Vc::double_v(Vc::Zero)))*(0.00100000/1.00000)*statesVc[20405+i]*statesVc[11872+i] -  CONSTANTS[98]*statesVc[20776+i]*(CONSTANTS[99] -  statesVc[20405+i]*(0.00100000/1.00000)*statesVc[11872+i])*(Vc::iif(CONSTANTS[99] -  statesVc[20405+i]*(0.00100000/1.00000)*statesVc[11872+i]>0.00000 , Vc::double_v(Vc::One), Vc::double_v(Vc::Zero))));
    ratesVc[12614+i] =  ( CONSTANTS[72]*statesVc[10759+i])*((CONSTANTS[74]+- statesVc[12614+i])+- statesVc[13356+i])+ - CONSTANTS[73]*statesVc[12614+i];
    ratesVc[12985+i] =  ( CONSTANTS[72]*statesVc[11501+i])*((CONSTANTS[74]+- statesVc[12985+i])+- statesVc[13727+i])+ - CONSTANTS[73]*statesVc[12985+i];
    ratesVc[13356+i] =  ( CONSTANTS[75]*(CONSTANTS[74]+- statesVc[12614+i]+- statesVc[13356+i]))*statesVc[17066+i]+ - CONSTANTS[76]*statesVc[13356+i];
    ratesVc[13727+i] =  ( CONSTANTS[75]*(CONSTANTS[74]+- statesVc[12985+i]+- statesVc[13727+i]))*statesVc[17437+i]+ - CONSTANTS[76]*statesVc[13727+i];
    ratesVc[14098+i] =  ( CONSTANTS[77]*statesVc[11130+i])*(CONSTANTS[79]+- statesVc[14098+i])+ - CONSTANTS[78]*statesVc[14098+i];
    ratesVc[14469+i] =  ( CONSTANTS[77]*statesVc[11872+i])*(CONSTANTS[79]+- statesVc[14469+i])+ - CONSTANTS[78]*statesVc[14469+i];
    ratesVc[14840+i] = ( ( CONSTANTS[80]*statesVc[10759+i])*statesVc[16324+i]+ - CONSTANTS[81]*statesVc[14840+i])+ - CONSTANTS[84]*((statesVc[14840+i]+- statesVc[15211+i])/CONSTANTS[108]);
    ratesVc[15211+i] = ( ( CONSTANTS[80]*statesVc[11501+i])*statesVc[16695+i]+ - CONSTANTS[81]*statesVc[15211+i])+ CONSTANTS[84]*((statesVc[14840+i]+- statesVc[15211+i])/CONSTANTS[109]);
    ratesVc[15582+i] = ( ( CONSTANTS[82]*statesVc[17066+i])*statesVc[16324+i]+ - CONSTANTS[83]*statesVc[15582+i])+ - CONSTANTS[84]*((statesVc[15582+i]+- statesVc[15953+i])/CONSTANTS[108]);
    ratesVc[15953+i] = ( ( CONSTANTS[82]*statesVc[17437+i])*statesVc[16695+i]+ - CONSTANTS[83]*statesVc[15953+i])+ CONSTANTS[84]*((statesVc[15582+i]+- statesVc[15953+i])/CONSTANTS[109]);
    ratesVc[16324+i] = (- ( ( CONSTANTS[80]*statesVc[10759+i])*statesVc[16324+i]+ - CONSTANTS[81]*statesVc[14840+i])+- ( ( CONSTANTS[82]*statesVc[17066+i])*statesVc[16324+i]+ - CONSTANTS[83]*statesVc[15582+i]))+ - CONSTANTS[84]*((statesVc[16324+i]+- statesVc[16695+i])/CONSTANTS[108]);
    ratesVc[16695+i] = (- ( ( CONSTANTS[80]*statesVc[11501+i])*statesVc[16695+i]+ - CONSTANTS[81]*statesVc[15211+i])+- ( ( CONSTANTS[82]*statesVc[17437+i])*statesVc[16695+i]+ - CONSTANTS[83]*statesVc[15953+i]))+ CONSTANTS[84]*((statesVc[16324+i]+- statesVc[16695+i])/CONSTANTS[109]);
    ratesVc[17066+i] = (- ( ( CONSTANTS[75]*(CONSTANTS[74]+- statesVc[12614+i]+- statesVc[13356+i]))*statesVc[17066+i]+ - CONSTANTS[76]*statesVc[13356+i])+- ( ( CONSTANTS[82]*statesVc[17066+i])*statesVc[16324+i]+ - CONSTANTS[83]*statesVc[15582+i]))+ - CONSTANTS[85]*((statesVc[17066+i]+- statesVc[17437+i])/CONSTANTS[108]);
    ratesVc[17437+i] = (- ( ( CONSTANTS[75]*(CONSTANTS[74]+- statesVc[12985+i]+- statesVc[13727+i]))*statesVc[17437+i]+ - CONSTANTS[76]*statesVc[13727+i])+- ( ( CONSTANTS[82]*statesVc[17437+i])*statesVc[16695+i]+ - CONSTANTS[83]*statesVc[15953+i]))+ CONSTANTS[85]*((statesVc[17066+i]+- statesVc[17437+i])/CONSTANTS[109]);
    ratesVc[17808+i] = (( ( CONSTANTS[69]*statesVc[11501+i])*statesVc[12243+i]+ - CONSTANTS[70]*statesVc[17808+i])+ - CONSTANTS[88]*statesVc[17808+i])+ CONSTANTS[89]*statesVc[18921+i];
    ratesVc[18550+i] = (((( CONSTANTS[69]*statesVc[11501+i]*statesVc[18179+i]+ - CONSTANTS[70]*statesVc[18550+i])+ CONSTANTS[86]*statesVc[12243+i])+ - CONSTANTS[87]*statesVc[18550+i])+ ( - CONSTANTS[69]*statesVc[11501+i])*statesVc[18550+i])+ CONSTANTS[70]*statesVc[18921+i];
    ratesVc[18921+i] = ((((( CONSTANTS[69]*statesVc[11501+i]*statesVc[18550+i]+ - CONSTANTS[70]*statesVc[18921+i])+ CONSTANTS[88]*statesVc[17808+i])+ - CONSTANTS[89]*statesVc[18921+i])+ - CONSTANTS[90]*statesVc[18921+i])+ CONSTANTS[91]*statesVc[19292+i])+ CONSTANTS[94]*statesVc[19663+i];
    ratesVc[19292+i] = (( CONSTANTS[90]*statesVc[18921+i]+ - CONSTANTS[91]*statesVc[19292+i])+ CONSTANTS[93]*statesVc[19663+i])+ - CONSTANTS[92]*statesVc[19292+i];
    ratesVc[19663+i] = ( - CONSTANTS[93]*statesVc[19663+i]+ CONSTANTS[92]*statesVc[19292+i])+ - CONSTANTS[94]*statesVc[19663+i];
    ratesVc[20034+i] =  (0.00100000/1.00000)*( CONSTANTS[92]*statesVc[19292+i] -  CONSTANTS[93]*statesVc[19663+i])+ -1.00000*CONSTANTS[95]*statesVc[20034+i]+ -1.00000*CONSTANTS[96]*((statesVc[20034+i] - statesVc[20405+i])/CONSTANTS[109]);
    ratesVc[20405+i] =  CONSTANTS[96]*((statesVc[20034+i] - statesVc[20405+i])/CONSTANTS[111]) -  1.00000*( CONSTANTS[97]*( statesVc[20405+i]*(0.00100000/1.00000)*statesVc[11872+i] - CONSTANTS[99])*(Vc::iif( statesVc[20405+i]*(0.00100000/1.00000)*statesVc[11872+i] - CONSTANTS[99]>0.00000 , Vc::double_v(Vc::One), Vc::double_v(Vc::Zero)))*(0.00100000/1.00000)*statesVc[20405+i]*statesVc[11872+i] -  CONSTANTS[98]*statesVc[20776+i]*(CONSTANTS[99] -  statesVc[20405+i]*(0.00100000/1.00000)*statesVc[11872+i])*(Vc::iif(CONSTANTS[99] -  statesVc[20405+i]*(0.00100000/1.00000)*statesVc[11872+i]>0.00000 , Vc::double_v(Vc::One), Vc::double_v(Vc::Zero))));
    ratesVc[20776+i] =  1.00000*( CONSTANTS[97]*( statesVc[20405+i]*(0.00100000/1.00000)*statesVc[11872+i] - CONSTANTS[99])*(Vc::iif( statesVc[20405+i]*(0.00100000/1.00000)*statesVc[11872+i] - CONSTANTS[99]>0.00000 , Vc::double_v(Vc::One), Vc::double_v(Vc::Zero)))*(0.00100000/1.00000)*statesVc[20405+i]*statesVc[11872+i] -  CONSTANTS[98]*statesVc[20776+i]*(CONSTANTS[99] -  statesVc[20405+i]*(0.00100000/1.00000)*statesVc[11872+i])*(Vc::iif(CONSTANTS[99] -  statesVc[20405+i]*(0.00100000/1.00000)*statesVc[11872+i]>0.00000 , Vc::double_v(Vc::One), Vc::double_v(Vc::Zero))));
    algebraicsVc[4823+i] = (Vc::iif(CONSTANTS[71]+- statesVc[12243+i]+- statesVc[17808+i]+- statesVc[18179+i]+- statesVc[18550+i]+- statesVc[18921+i]+- statesVc[19292+i]+- statesVc[19663+i]>0.00000 , (Vc::double_v(Vc::One)*CONSTANTS[71])+- statesVc[12243+i]+- statesVc[17808+i]+- statesVc[18179+i]+- statesVc[18550+i]+- statesVc[18921+i]+- statesVc[19292+i]+- statesVc[19663+i] , Vc::double_v(Vc::Zero)));
    ratesVc[11501+i] = (((( - CONSTANTS[61]*((statesVc[11501+i]/(statesVc[11501+i]+CONSTANTS[62]))/CONSTANTS[109])+ CONSTANTS[63]*((statesVc[11872+i]+- statesVc[11501+i])/CONSTANTS[109]))+ CONSTANTS[64]*((statesVc[10759+i] - statesVc[11501+i])/CONSTANTS[109]))+- ((((((( CONSTANTS[69]*statesVc[11501+i]*algebraicsVc[4823+i]+ - CONSTANTS[70]*statesVc[12243+i])+ CONSTANTS[69]*statesVc[11501+i]*statesVc[12243+i])+ - CONSTANTS[70]*statesVc[17808+i])+ CONSTANTS[69]*statesVc[11501+i]*statesVc[18179+i])+ - CONSTANTS[70]*statesVc[18550+i])+ CONSTANTS[69]*statesVc[11501+i]*statesVc[18550+i])+ - CONSTANTS[70]*statesVc[18921+i]))+- ( ( CONSTANTS[72]*statesVc[11501+i])*(CONSTANTS[74]+- statesVc[12985+i]+- statesVc[13727+i])+ - CONSTANTS[73]*statesVc[12985+i]))+- ( ( CONSTANTS[80]*statesVc[11501+i])*statesVc[16695+i]+ - CONSTANTS[81]*statesVc[15211+i]);
    ratesVc[12243+i] = (((( ( CONSTANTS[69]*statesVc[11501+i])*algebraicsVc[4823+i]+ - CONSTANTS[70]*statesVc[12243+i])+ ( - CONSTANTS[69]*statesVc[11501+i])*statesVc[12243+i])+ CONSTANTS[70]*statesVc[17808+i])+ - CONSTANTS[86]*statesVc[12243+i])+ CONSTANTS[87]*statesVc[18550+i];
    ratesVc[18179+i] = (( ( - CONSTANTS[69]*statesVc[11501+i])*statesVc[18179+i]+ CONSTANTS[70]*statesVc[18550+i])+ CONSTANTS[86]*algebraicsVc[4823+i])+ - CONSTANTS[87]*statesVc[18179+i];
    algebraicsVc[4452+i] =  ((( (statesVc[19292+i]/CONSTANTS[71])*CONSTANTS[101]+ (statesVc[19663+i]/CONSTANTS[71])*CONSTANTS[102]) - CONSTANTS[103])/CONSTANTS[104])*(Vc::iif(parametersVc[371+i]>=0.635000&&parametersVc[371+i]<=0.850000 ,  (0.700000/(0.850000 - 0.635000))*(parametersVc[371+i] - 0.635000) ,Vc::iif( parametersVc[371+i]>0.850000&&parametersVc[371+i]<=1.17000 , 0.700000+ (0.300000/(1.17000 - 0.850000))*(parametersVc[371+i] - 0.850000) ,Vc::iif( parametersVc[371+i]>1.17000&&parametersVc[371+i]<=1.25500 , Vc::double_v(Vc::One),Vc::iif( parametersVc[371+i]>1.25500&&parametersVc[371+i]<=1.97000 , 1.00000 -  (1.00000/(1.97000 - 1.25500))*(parametersVc[371+i] - 1.25500) , Vc::double_v(Vc::Zero))))));
    ratesVc[10388+i] = algebraicsVc[4452+i];
    algebraicsVc[371+i] =  CONSTANTS[16]*((statesVc[0+i] - CONSTANTS[21])/(1.00000 - exponential(- ((statesVc[0+i] - CONSTANTS[21])/CONSTANTS[32]))));
    algebraicsVc[5565+i] =  CONSTANTS[19]*exponential(- ((statesVc[0+i] - CONSTANTS[21])/CONSTANTS[34]));
    ratesVc[2968+i] =  algebraicsVc[371+i]*(1.00000 - statesVc[2968+i]) -  algebraicsVc[5565+i]*statesVc[2968+i];
    algebraicsVc[742+i] = 1.00000/(1.00000+exponential((statesVc[0+i] - CONSTANTS[25])/CONSTANTS[28]));
    algebraicsVc[5936+i] =  1000.00*exponential(- ((statesVc[0+i]+40.0000)/25.7500));
    ratesVc[3339+i] = (algebraicsVc[742+i] - statesVc[3339+i])/algebraicsVc[5936+i];
    algebraicsVc[1484+i] =  CONSTANTS[15]*((statesVc[0+i] - CONSTANTS[20])/(1.00000 - exponential(- ((statesVc[0+i] - CONSTANTS[20])/CONSTANTS[31]))));
    algebraicsVc[6678+i] =  CONSTANTS[18]*exponential(- ((statesVc[0+i] - CONSTANTS[20])/CONSTANTS[33]));
    ratesVc[3710+i] =  algebraicsVc[1484+i]*(1.00000 - statesVc[3710+i]) -  algebraicsVc[6678+i]*statesVc[3710+i];
    algebraicsVc[1113+i] =  CONSTANTS[14]*exponential(- ((statesVc[0+i] - CONSTANTS[22])/CONSTANTS[29]));
    algebraicsVc[6307+i] = CONSTANTS[17]/(1.00000+exponential(- ((statesVc[0+i] - CONSTANTS[22])/CONSTANTS[30])));
    ratesVc[4081+i] =  algebraicsVc[1113+i]*(1.00000 - statesVc[4081+i]) -  algebraicsVc[6307+i]*statesVc[4081+i];
    algebraicsVc[1855+i] = 1.00000/(1.00000+exponential((statesVc[0+i] - CONSTANTS[24])/CONSTANTS[27]));
    algebraicsVc[7049+i] = 8571.00/(0.200000+ 5.65000*pow2((statesVc[0+i]+CONSTANTS[48])/100.000));
    ratesVc[4452+i] = (algebraicsVc[1855+i] - statesVc[4452+i])/algebraicsVc[7049+i];
    algebraicsVc[2226+i] =  CONSTANTS[16]*((statesVc[371+i] - CONSTANTS[21])/(1.00000 - exponential(- ((statesVc[371+i] - CONSTANTS[21])/CONSTANTS[32]))));
    algebraicsVc[7420+i] =  CONSTANTS[19]*exponential(- ((statesVc[371+i] - CONSTANTS[21])/CONSTANTS[34]));
    ratesVc[4823+i] =  algebraicsVc[2226+i]*(1.00000 - statesVc[4823+i]) -  algebraicsVc[7420+i]*statesVc[4823+i];
    algebraicsVc[2597+i] = 1.00000/(1.00000+exponential((statesVc[371+i] - CONSTANTS[25])/CONSTANTS[28]));
    algebraicsVc[7791+i] =  1.00000*exponential(- ((statesVc[371+i]+40.0000)/25.7500));
    ratesVc[5194+i] = (algebraicsVc[2597+i] - statesVc[5194+i])/algebraicsVc[7791+i];
    algebraicsVc[3339+i] =  CONSTANTS[15]*((statesVc[371+i] - CONSTANTS[20])/(1.00000 - exponential(- ((statesVc[371+i] - CONSTANTS[20])/CONSTANTS[31]))));
    algebraicsVc[8533+i] =  CONSTANTS[18]*exponential(- ((statesVc[371+i] - CONSTANTS[20])/CONSTANTS[33]));
    ratesVc[5565+i] =  algebraicsVc[3339+i]*(1.00000 - statesVc[5565+i]) -  algebraicsVc[8533+i]*statesVc[5565+i];
    algebraicsVc[2968+i] =  CONSTANTS[14]*exponential(- ((statesVc[371+i] - CONSTANTS[22])/CONSTANTS[29]));
    algebraicsVc[8162+i] = CONSTANTS[17]/(1.00000+exponential(- ((statesVc[371+i] - CONSTANTS[22])/CONSTANTS[30])));
    ratesVc[5936+i] =  algebraicsVc[2968+i]*(1.00000 - statesVc[5936+i]) -  algebraicsVc[8162+i]*statesVc[5936+i];
    algebraicsVc[3710+i] = 1.00000/(1.00000+exponential((statesVc[371+i] - CONSTANTS[24])/CONSTANTS[27]));
    algebraicsVc[8904+i] = 8571.00/(0.200000+ 5.65000*pow2((statesVc[371+i]+CONSTANTS[48])/100.000));
    ratesVc[6307+i] = (algebraicsVc[3710+i] - statesVc[6307+i])/algebraicsVc[8904+i];
    algebraicsVc[4081+i] =  0.500000*CONSTANTS[58]*exponential((statesVc[371+i] - CONSTANTS[60])/( 8.00000*CONSTANTS[59]));
    algebraicsVc[9275+i] =  0.500000*CONSTANTS[58]*exponential((CONSTANTS[60] - statesVc[371+i])/( 8.00000*CONSTANTS[59]));
    ratesVc[8533+i] =  - CONSTANTS[55]*statesVc[8533+i]+ CONSTANTS[56]*statesVc[6678+i]+ -4.00000*algebraicsVc[4081+i]*statesVc[8533+i]+ algebraicsVc[9275+i]*statesVc[8904+i];
    ratesVc[6678+i] =  CONSTANTS[55]*statesVc[8533+i]+ - CONSTANTS[56]*statesVc[6678+i]+( -4.00000*algebraicsVc[4081+i]*statesVc[6678+i])/CONSTANTS[57]+ CONSTANTS[57]*algebraicsVc[9275+i]*statesVc[7049+i];
    ratesVc[8904+i] =  4.00000*algebraicsVc[4081+i]*statesVc[8533+i]+ - algebraicsVc[9275+i]*statesVc[8904+i]+( - CONSTANTS[55]*statesVc[8904+i])/CONSTANTS[57]+ CONSTANTS[57]*CONSTANTS[56]*statesVc[7049+i]+ -3.00000*algebraicsVc[4081+i]*statesVc[8904+i]+ 2.00000*algebraicsVc[9275+i]*statesVc[9275+i];
    ratesVc[7049+i] = ( CONSTANTS[55]*statesVc[8904+i])/CONSTANTS[57]+ - CONSTANTS[56]*CONSTANTS[57]*statesVc[7049+i]+( 4.00000*algebraicsVc[4081+i]*statesVc[6678+i])/CONSTANTS[57]+ - CONSTANTS[57]*algebraicsVc[9275+i]*statesVc[7049+i]+( -3.00000*algebraicsVc[4081+i]*statesVc[7049+i])/CONSTANTS[57]+ 2.00000*CONSTANTS[57]*algebraicsVc[9275+i]*statesVc[7420+i];
    ratesVc[9275+i] =  3.00000*algebraicsVc[4081+i]*statesVc[8904+i]+ -2.00000*algebraicsVc[9275+i]*statesVc[9275+i]+( - CONSTANTS[55]*statesVc[9275+i])/pow2(CONSTANTS[57])+ pow2(CONSTANTS[57])*CONSTANTS[56]*statesVc[7420+i]+ -2.00000*algebraicsVc[4081+i]*statesVc[9275+i]+ 3.00000*algebraicsVc[9275+i]*statesVc[9646+i];
    ratesVc[7420+i] = ( 3.00000*algebraicsVc[4081+i]*statesVc[7049+i])/CONSTANTS[57]+ -2.00000*CONSTANTS[57]*algebraicsVc[9275+i]*statesVc[7420+i]+( CONSTANTS[55]*statesVc[9275+i])/pow2(CONSTANTS[57])+ - CONSTANTS[56]*pow2(CONSTANTS[57])*statesVc[7420+i]+( -2.00000*algebraicsVc[4081+i]*statesVc[7420+i])/CONSTANTS[57]+ 3.00000*CONSTANTS[57]*algebraicsVc[9275+i]*statesVc[7791+i];
    ratesVc[9646+i] =  2.00000*algebraicsVc[4081+i]*statesVc[9275+i]+ -3.00000*algebraicsVc[9275+i]*statesVc[9646+i]+( - CONSTANTS[55]*statesVc[9646+i])/pow3(CONSTANTS[57])+ CONSTANTS[56]*pow3(CONSTANTS[57])*statesVc[7791+i]+ - algebraicsVc[4081+i]*statesVc[9646+i]+ 4.00000*algebraicsVc[9275+i]*statesVc[10017+i];
    ratesVc[7791+i] = ( CONSTANTS[55]*statesVc[9646+i])/pow3(CONSTANTS[57])+ - CONSTANTS[56]*pow3(CONSTANTS[57])*statesVc[7791+i]+( 2.00000*algebraicsVc[4081+i]*statesVc[7420+i])/CONSTANTS[57]+ -3.00000*algebraicsVc[9275+i]*CONSTANTS[57]*statesVc[7791+i]+( - algebraicsVc[4081+i]*statesVc[7791+i])/CONSTANTS[57]+ 4.00000*CONSTANTS[57]*algebraicsVc[9275+i]*statesVc[8162+i];
    ratesVc[10017+i] =  algebraicsVc[4081+i]*statesVc[9646+i]+ -4.00000*algebraicsVc[9275+i]*statesVc[10017+i]+( - CONSTANTS[55]*statesVc[10017+i])/pow4(CONSTANTS[57])+ CONSTANTS[56]*pow4(CONSTANTS[57])*statesVc[8162+i];
    ratesVc[8162+i] = ( algebraicsVc[4081+i]*statesVc[7791+i])/CONSTANTS[57]+ -4.00000*CONSTANTS[57]*algebraicsVc[9275+i]*statesVc[8162+i]+( CONSTANTS[55]*statesVc[10017+i])/pow4(CONSTANTS[57])+ - CONSTANTS[56]*pow4(CONSTANTS[57])*statesVc[8162+i];
    algebraicsVc[11501+i] =  statesVc[0+i]*((statesVc[1113+i] -  statesVc[1484+i]*exponential(( -1.00000*CONSTANTS[6]*statesVc[0+i])/( CONSTANTS[35]*CONSTANTS[36])))/(1.00000 - exponential(( -1.00000*CONSTANTS[6]*statesVc[0+i])/( CONSTANTS[35]*CONSTANTS[36]))));
    algebraicsVc[5194+i] =  (( CONSTANTS[35]*CONSTANTS[36])/CONSTANTS[6])*log(statesVc[1484+i]/statesVc[1113+i]);
    algebraicsVc[13727+i] =  statesVc[1484+i]*exponential( ( - CONSTANTS[41]*algebraicsVc[5194+i])*(CONSTANTS[6]/( CONSTANTS[35]*CONSTANTS[36])));
    algebraicsVc[14098+i] =  CONSTANTS[40]*(pow2(algebraicsVc[13727+i])/(CONSTANTS[42]+pow2(algebraicsVc[13727+i])));
    algebraicsVc[14469+i] = 1.00000 - powReciprocal1(1.00000+( CONSTANTS[43]*(1.00000+pow2(algebraicsVc[13727+i])/CONSTANTS[42]))/( pow2(CONSTANTS[46])*exponential(( 2.00000*(1.00000 - CONSTANTS[41])*statesVc[0+i]*CONSTANTS[6])/( CONSTANTS[35]*CONSTANTS[36]))));
    algebraicsVc[14840+i] =  algebraicsVc[14098+i]*algebraicsVc[14469+i];
    algebraicsVc[15211+i] =  algebraicsVc[14840+i]*(Vc::iif(algebraicsVc[11501+i]>0.00000 , Vc::double_v(Vc::One), Vc::double_v(Vc::Zero)))*(algebraicsVc[11501+i]/50.0000);
    algebraicsVc[15582+i] =  ( CONSTANTS[38]*pow4(statesVc[2968+i]))*statesVc[3339+i];
    algebraicsVc[15953+i] =  algebraicsVc[15582+i]*(algebraicsVc[11501+i]/50.0000);
    algebraicsVc[17437+i] =  (1.00000/7.00000)*(exponential(statesVc[2597+i]/67.3000) - 1.00000);
    algebraicsVc[17808+i] = powReciprocal1(1.00000+ 0.120000*exponential( -0.100000*statesVc[0+i]*(CONSTANTS[6]/( CONSTANTS[35]*CONSTANTS[36])))+ 0.0400000*algebraicsVc[17437+i]*exponential(- ( statesVc[0+i]*(CONSTANTS[6]/( CONSTANTS[35]*CONSTANTS[36])))));
    algebraicsVc[18179+i] =  CONSTANTS[6]*(CONSTANTS[47]/( pow2(1.00000+CONSTANTS[44]/statesVc[1484+i])*pow3(1.00000+CONSTANTS[45]/statesVc[1855+i])));
    algebraicsVc[18550+i] =  algebraicsVc[18179+i]*algebraicsVc[17808+i];
    ratesVc[1484+i] = (algebraicsVc[15211+i]+algebraicsVc[15953+i]+CONSTANTS[12]+ - 2.00000*algebraicsVc[18550+i])/( (1000.00/1.00000)*CONSTANTS[6]*CONSTANTS[5])+(statesVc[742+i] - statesVc[1484+i])/CONSTANTS[10];
    algebraicsVc[16695+i] =  ( ( CONSTANTS[39]*pow3(statesVc[3710+i]))*statesVc[4081+i])*statesVc[4452+i];
    algebraicsVc[16324+i] =  statesVc[0+i]*((statesVc[1855+i] -  statesVc[2597+i]*exponential(( -1.00000*CONSTANTS[6]*statesVc[0+i])/( CONSTANTS[35]*CONSTANTS[36])))/(1.00000 - exponential(( -1.00000*CONSTANTS[6]*statesVc[0+i])/( CONSTANTS[35]*CONSTANTS[36]))));
    algebraicsVc[17066+i] =  algebraicsVc[16695+i]*(algebraicsVc[16324+i]/75.0000);
    ratesVc[2597+i] = (algebraicsVc[17066+i]+CONSTANTS[13]+ 3.00000*algebraicsVc[18550+i])/( (1000.00/1.00000)*CONSTANTS[6]*CONSTANTS[5])+(statesVc[2226+i] - statesVc[2597+i])/CONSTANTS[11];
    algebraicsVc[0+i] =  (1000.00/1.00000)*((statesVc[0+i] - statesVc[371+i])/CONSTANTS[2]);
    algebraicsVc[10017+i] = 156.500/(5.00000+exponential(( - CONSTANTS[6]*algebraicsVc[5194+i])/( CONSTANTS[35]*CONSTANTS[36])));
    algebraicsVc[10388+i] = 156.500 -  5.00000*algebraicsVc[10017+i];
    algebraicsVc[12614+i] =  statesVc[0+i]*((algebraicsVc[10017+i] -  algebraicsVc[10388+i]*exponential(( CONSTANTS[6]*statesVc[0+i])/( CONSTANTS[35]*CONSTANTS[36])))/(1.00000 - exponential(( CONSTANTS[6]*statesVc[0+i])/( CONSTANTS[35]*CONSTANTS[36]))));
    algebraicsVc[12243+i] = 1.00000/(1.00000+exponential((statesVc[0+i] - CONSTANTS[23])/CONSTANTS[26]));
    algebraicsVc[12985+i] =  CONSTANTS[37]*pow4(algebraicsVc[12243+i]);
    algebraicsVc[13356+i] =  algebraicsVc[12985+i]*(algebraicsVc[12614+i]/45.0000);
    algebraicsVc[18921+i] = algebraicsVc[13356+i]+algebraicsVc[15211+i]+algebraicsVc[15953+i]+algebraicsVc[17066+i]+algebraicsVc[18550+i]+- parametersVc[0+i];
    ratesVc[0+i] = - ((algebraicsVc[18921+i]+algebraicsVc[0+i])/CONSTANTS[0]);
    algebraicsVc[11872+i] =  statesVc[371+i]*((statesVc[1113+i] -  statesVc[742+i]*exponential(( -1.00000*CONSTANTS[6]*statesVc[371+i])/( CONSTANTS[35]*CONSTANTS[36])))/(1.00000 - exponential(( -1.00000*CONSTANTS[6]*statesVc[371+i])/( CONSTANTS[35]*CONSTANTS[36]))));
    algebraicsVc[9646+i] =  (( CONSTANTS[35]*CONSTANTS[36])/CONSTANTS[6])*log(statesVc[742+i]/statesVc[1113+i]);
    algebraicsVc[20776+i] =  statesVc[742+i]*exponential( ( - CONSTANTS[41]*algebraicsVc[9646+i])*(CONSTANTS[6]/( CONSTANTS[35]*CONSTANTS[36])));
    algebraicsVc[21147+i] =  CONSTANTS[40]*(pow2(algebraicsVc[20776+i])/(CONSTANTS[42]+pow2(algebraicsVc[20776+i])));
    algebraicsVc[21518+i] = 1.00000 - powReciprocal1(1.00000+( CONSTANTS[43]*(1.00000+pow2(algebraicsVc[20776+i])/CONSTANTS[42]))/( pow2(CONSTANTS[46])*exponential(( 2.00000*(1.00000 - CONSTANTS[41])*statesVc[371+i]*CONSTANTS[6])/( CONSTANTS[35]*CONSTANTS[36]))));
    algebraicsVc[21889+i] =  algebraicsVc[21147+i]*algebraicsVc[21518+i];
    algebraicsVc[22260+i] =  CONSTANTS[50]*algebraicsVc[21889+i]*(algebraicsVc[11872+i]/50.0000);
    algebraicsVc[22631+i] =  ( CONSTANTS[38]*pow4(statesVc[4823+i]))*statesVc[5194+i];
    algebraicsVc[23002+i] =  CONSTANTS[51]*algebraicsVc[22631+i]*(algebraicsVc[11872+i]/50.0000);
    algebraicsVc[24486+i] =  (1.00000/7.00000)*(exponential(statesVc[2226+i]/67.3000) - 1.00000);
    algebraicsVc[24857+i] = powReciprocal1(1.00000+ 0.120000*exponential( -0.100000*statesVc[371+i]*(CONSTANTS[6]/( CONSTANTS[35]*CONSTANTS[36])))+ 0.0400000*algebraicsVc[24486+i]*exponential(- ( statesVc[371+i]*(CONSTANTS[6]/( CONSTANTS[35]*CONSTANTS[36])))));
    algebraicsVc[25228+i] =  CONSTANTS[6]*(CONSTANTS[47]/( pow2(1.00000+CONSTANTS[44]/statesVc[742+i])*pow3(1.00000+CONSTANTS[45]/statesVc[1855+i])));
    algebraicsVc[25599+i] =  CONSTANTS[53]*algebraicsVc[25228+i]*algebraicsVc[24857+i];
    ratesVc[1113+i] =  - CONSTANTS[9]*((algebraicsVc[22260+i]+algebraicsVc[23002+i]+CONSTANTS[12]+ - 2.00000*algebraicsVc[25599+i])/( (1000.00/1.00000)*CONSTANTS[6]*CONSTANTS[3])) - (algebraicsVc[15211+i]+algebraicsVc[15953+i]+CONSTANTS[12]+ -2.00000*algebraicsVc[18550+i])/( (1000.00/1.00000)*CONSTANTS[6]*CONSTANTS[4]);
    ratesVc[742+i] = (algebraicsVc[22260+i]+algebraicsVc[23002+i]+CONSTANTS[12]+ - 2.00000*algebraicsVc[25599+i])/( (1000.00/1.00000)*CONSTANTS[6]*CONSTANTS[3]) - (statesVc[742+i] - statesVc[1484+i])/CONSTANTS[7];
    algebraicsVc[23744+i] =  ( ( CONSTANTS[39]*pow3(statesVc[5565+i]))*statesVc[5936+i])*statesVc[6307+i];
    algebraicsVc[23373+i] =  statesVc[371+i]*((statesVc[1855+i] -  statesVc[2226+i]*exponential(( -1.00000*CONSTANTS[6]*statesVc[371+i])/( CONSTANTS[35]*CONSTANTS[36])))/(1.00000 - exponential(( -1.00000*CONSTANTS[6]*statesVc[371+i])/( CONSTANTS[35]*CONSTANTS[36]))));
    algebraicsVc[24115+i] =  CONSTANTS[52]*algebraicsVc[23744+i]*(algebraicsVc[23373+i]/75.0000);
    ratesVc[1855+i] =  - CONSTANTS[9]*((algebraicsVc[24115+i]+CONSTANTS[13]+ 3.00000*algebraicsVc[25599+i])/( (1000.00/1.00000)*CONSTANTS[6]*CONSTANTS[3])) - (algebraicsVc[17066+i]+CONSTANTS[13]+ 3.00000*algebraicsVc[18550+i])/( (1000.00/1.00000)*CONSTANTS[6]*CONSTANTS[4]);
    ratesVc[2226+i] = (algebraicsVc[24115+i]+CONSTANTS[13]+ 3.00000*algebraicsVc[25599+i])/( (1000.00/1.00000)*CONSTANTS[6]*CONSTANTS[3]) - (statesVc[2226+i] - statesVc[2597+i])/CONSTANTS[8];
    algebraicsVc[10759+i] = 156.500/(5.00000+exponential(( - CONSTANTS[6]*algebraicsVc[9646+i])/( CONSTANTS[35]*CONSTANTS[36])));
    algebraicsVc[11130+i] = 156.500 -  5.00000*algebraicsVc[10759+i];
    algebraicsVc[19663+i] =  statesVc[371+i]*((algebraicsVc[10759+i] -  algebraicsVc[11130+i]*exponential(( CONSTANTS[6]*statesVc[371+i])/( CONSTANTS[35]*CONSTANTS[36])))/(1.00000 - exponential(( CONSTANTS[6]*statesVc[371+i])/( CONSTANTS[35]*CONSTANTS[36]))));
    algebraicsVc[19292+i] = 1.00000/(1.00000+exponential((statesVc[371+i] - CONSTANTS[23])/CONSTANTS[26]));
    algebraicsVc[20034+i] =  CONSTANTS[37]*pow4(algebraicsVc[19292+i]);
    algebraicsVc[20405+i] =  CONSTANTS[49]*algebraicsVc[20034+i]*(algebraicsVc[19663+i]/45.0000);
    algebraicsVc[25970+i] = algebraicsVc[20405+i]+algebraicsVc[22260+i]+algebraicsVc[23002+i]+algebraicsVc[24115+i]+algebraicsVc[25599+i];
    ratesVc[371+i] = - ((algebraicsVc[25970+i] - algebraicsVc[0+i]/CONSTANTS[1])/CONSTANTS[0]);
