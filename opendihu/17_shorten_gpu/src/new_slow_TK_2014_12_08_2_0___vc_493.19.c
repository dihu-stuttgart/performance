...
void computeCellMLRightHandSide(void *context, double t, double *states, double *rates, double *algebraics, double *parameters)
{
  ...
  {
    std::cout << "Fatal error in compiled library of source file \"src/new_slow_TK_2014_12_08_2_0___vc_493.19.c\", size of SIMD register in compiled code (" << Vc::double_v::Size << ") does not match opendihu code (4)." << std::endl;
