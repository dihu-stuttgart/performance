...
os.environ['OPENCMISS_SCE_FILE'] = 'thomas_variant_heun.sce'
...
def run(xi1,ode,msolver,mprecond):   
  ...
  command = "$OPENCMISS_REL_DIR/cuboid $OPENCMISS_SCE_FILE $OPENCMISS_INPUT_DIR xi1={} TimeStop=1 StimPeriod=1"\
  .format(int(xi1))
