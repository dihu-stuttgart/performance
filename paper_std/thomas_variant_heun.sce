# Scenario name: variant of reference values for paper
# Date: 7.9.17
...
NumberGlobalXElements = 4       # number of finite elasticty elements in x-direction, alias x
NumberGlobalYElements = 4       # number of finite elasticty elements in y-direction, alias y
NumberGlobalZElements = 4       # number of finite elasticty elements in z-direction, alias z
...
# solvers
ODESolverId = 5                 # 0D problem, ODE solver type: 1=explicit Euler, 2=BDF
...
StimPeriod = 5.0                    # the duration between subsequent stimulation spikes, former PERIODD
